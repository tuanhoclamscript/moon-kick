...
--------------------------------------------------------------------------------
-- [SETTINGS] CẤU HÌNH MÀU SẮC & ICON
--------------------------------------------------------------------------------
local Theme = {
...
Header.Text = "FM Kick - Gear Check (Btuan)"
...
--------------------------------------------------------------------------------
-- [DRAGGABLE] CHỨC NĂNG KÉO THẢ (Mượt mà hơn)
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- [LOGIC FUNCTIONS] CÁC HÀM XỬ LÝ (Giữ nguyên logic của bạn)
--------------------------------------------------------------------------------
...
function getMoonState()
	...
	if moonTexture == moon5 then return "Moon5 (FULL)"
...
function checkGearStatus()
	local success, result = pcall(function()
		...
		elseif v229 == 3 then return "train tiếp đi đm"
		elseif v229 == 5 then return "Xong race r đấy địt mẹ m"
		elseif v229 == 6 then return "Upgrade: " .. (v228 - 2) .. "/3 Done" end
		if v229 ~= 8 then return "xong train đang cbi đi trials r " end
...
--------------------------------------------------------------------------------
-- [MAIN LOOP] VÒNG LẶP CẬP NHẬT UI
--------------------------------------------------------------------------------
task.spawn(function()
	while true do
...
-- Thông báo khởi động
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Ntramcutiii=))", Text = "Improved Ui Btuan Dev", Duration = 10})
